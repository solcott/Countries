...
import com.apollographql.apollo.api.Optional.Companion
...
interface CountriesApi {
     ...
     * @param continents when not empty, keeps only countries in these continents. The API
     *   matches on the continent **code** (e.g. "EU", "AS"), not its display name. Empty list returns all
     *   continents.
     */
    fun countriesAsFlow(
